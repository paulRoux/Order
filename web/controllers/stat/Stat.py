...
from common.libs.Helper import get_format_date, i_pagination, get_dict_filter_field, select_filter_obj
...
def food():
    ...
    date_list = []
    if list:
        food_map = get_dict_filter_field(Food, Food.id, "id", select_filter_obj(list, "food_id"))
        for item in list:
