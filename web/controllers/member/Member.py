...
from common.libs.Helper import ops_render, i_pagination, get_current_date, get_dict_filter_field, select_filter_obj
...
def comment():
    ...
    data_list = []
    if comment_list:
        member_map = get_dict_filter_field(Member, Member.id, "id", select_filter_obj(comment_list, "member_id"))
        food_ids = []
