...
from common.libs.Helper import get_format_date,get_current_date
...
class JobTask():
    ...
    def run(self, params):
        ...
        date = params['param'][0] if params['param'] and len(params['param']) else get_format_date(format="%Y-%m-%d")
        if not act:
            return
